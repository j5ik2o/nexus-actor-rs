...
pub struct MessageHeader {
  ...
  pub header_data: ::std::collections::HashMap<::prost::alloc::string::String, ::prost::alloc::string::String>,
}
#[allow(clippy::derive_partial_eq_without_eq)]
#[derive(Clone, PartialEq, ::prost::Message)]
...
pub mod remoting_client {
    ...
    <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
  {
    ...
    pub fn with_interceptor<F>(inner: T, interceptor: F) -> RemotingClient<InterceptedService<T, F>>
    where
    ...
    pub async fn receive(
    ...
    ) -> std::result::Result<tonic::Response<tonic::codec::Streaming<super::RemoteMessage>>, tonic::Status> {
      self
        .inner
        .ready()
        .await
      ...
      req
        .extensions_mut()
        .insert(GrpcMethod::new("remote.Remoting", "Receive"));
    ...
    pub async fn list_processes(
      ...
      self
        ...
        .map_err(|e| tonic::Status::new(tonic::Code::Unknown, format!("Service was not ready: {}", e.into())))?;
      let codec = tonic::codec::ProstCodec::default();
      let path = http::uri::PathAndQuery::from_static("/remote.Remoting/ListProcesses");
    ...
    ) -> std::result::Result<tonic::Response<super::GetProcessDiagnosticsResponse>, tonic::Status> {
      self
        .inner
        .ready()
        .await
        .map_err(|e| tonic::Status::new(tonic::Code::Unknown, format!("Service was not ready: {}", e.into())))?;
      let codec = tonic::codec::ProstCodec::default();
      let path = http::uri::PathAndQuery::from_static("/remote.Remoting/GetProcessDiagnostics");
      let mut req = request.into_request();
      req
        .extensions_mut()
...
pub mod remoting_server {
  ...
  pub trait Remoting: std::marker::Send + std::marker::Sync + 'static {
    ...
    type ReceiveStream: tonic::codegen::tokio_stream::Stream<Item = std::result::Result<super::RemoteMessage, tonic::Status>>
      + std::marker::Send
      + 'static;
    async fn receive(
      &self,
    ...
    fn call(&mut self, req: http::Request<B>) -> Self::Future {
      match req.uri().path() {
        "/remote.Remoting/Receive" => {
          ...
          impl<T: Remoting> tonic::server::StreamingService<super::RemoteMessage> for ReceiveSvc<T> {
            type Future = BoxFuture<tonic::Response<Self::ResponseStream>, tonic::Status>;
            type Response = super::RemoteMessage;
            type ResponseStream = T::ReceiveStream;

            fn call(&mut self, request: tonic::Request<tonic::Streaming<super::RemoteMessage>>) -> Self::Future {
              let inner = Arc::clone(&self.0);
              let fut = async move { <T as Remoting>::receive(&inner, request).await };
              Box::pin(fut)
            }
          }
        ...
        "/remote.Remoting/ListProcesses" => {
          ...
          impl<T: Remoting> tonic::server::UnaryService<super::ListProcessesRequest> for ListProcessesSvc<T> {
            type Future = BoxFuture<tonic::Response<Self::Response>, tonic::Status>;
            type Response = super::ListProcessesResponse;

            fn call(&mut self, request: tonic::Request<super::ListProcessesRequest>) -> Self::Future {
              let inner = Arc::clone(&self.0);
              let fut = async move { <T as Remoting>::list_processes(&inner, request).await };
              Box::pin(fut)
            }
          }
          let accept_compression_encodings = self.accept_compression_encodings;
        ...
        "/remote.Remoting/GetProcessDiagnostics" => {
          ...
          impl<T: Remoting> tonic::server::UnaryService<super::GetProcessDiagnosticsRequest> for GetProcessDiagnosticsSvc<T> {
            type Future = BoxFuture<tonic::Response<Self::Response>, tonic::Status>;
            type Response = super::GetProcessDiagnosticsResponse;

            fn call(&mut self, request: tonic::Request<super::GetProcessDiagnosticsRequest>) -> Self::Future {
              let inner = Arc::clone(&self.0);
              let fut = async move { <T as Remoting>::get_process_diagnostics(&inner, request).await };
              Box::pin(fut)
            }
          }
          let accept_compression_encodings = self.accept_compression_encodings;
