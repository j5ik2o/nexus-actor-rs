  ...
  impl State {
    ...
    pub fn as_str_name(&self) -> &'static str {
      match self {
        ...
        State::IncorrectTopology => "incorrect_topology",
      }
    }
...
impl DeliveryStatus {
  ...
  pub fn as_str_name(&self) -> &'static str {
    match self {
      ...
      DeliveryStatus::SubscriberNoLongerReachable => "SubscriberNoLongerReachable",
      DeliveryStatus::Timeout => "Timeout",
      DeliveryStatus::OtherError => "OtherError",
    }
  }
...
pub struct GossipState {
  ...
  pub members: ::std::collections::HashMap<::prost::alloc::string::String, GossipMemberState>,
}
...
pub struct GossipMemberState {
  #[prost(map = "string, message", tag = "1")]
  pub values: ::std::collections::HashMap<::prost::alloc::string::String, GossipKeyValue>,
}
...
pub struct GossipMap {
  #[prost(map = "string, message", tag = "1")]
  pub items: ::std::collections::HashMap<::prost::alloc::string::String, ::prost_types::Any>,
}
