...
func (g *HelloGrainClient) Reenterable(r *ReenterableRequest, opts ...cluster.GrainCallOption) (*ReenterableResponse, error) {
	if g.cluster.Config.RequestLog {
		g.cluster.Logger().Info("Requesting", slog.String("identity", g.Identity), slog.String("kind", "Hello"), slog.String("method", "Reenterable"), slog.Any("request", r))
	}
	bytes, err := proto.Marshal(r)
	if err != nil {
		return nil, err
...
func (g *HelloGrainClient) Hello(r *HelloRequest, opts ...cluster.GrainCallOption) (*HelloResponse, error) {
	if g.cluster.Config.RequestLog {
		g.cluster.Logger().Info("Requesting", slog.String("identity", g.Identity), slog.String("kind", "Hello"), slog.String("method", "Hello"), slog.Any("request", r))
	}
	bytes, err := proto.Marshal(r)
	if err != nil {
		return nil, err
